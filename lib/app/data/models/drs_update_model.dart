...
DrsUpdateRequestModel drsUpdateRequestModelFromJson(String str) => DrsUpdateRequestModel.fromJson(json.decode(str));

String drsUpdateRequestModelToJson(DrsUpdateRequestModel data) => json.encode(data.toJson());

class DrsUpdateRequestModel {
  DrsUpdateSummary drsSummary;
  List<DrsUpdateDetail> updateDRSLits;
  double loadingCharge;
  String baseUserName;

  DrsUpdateRequestModel({
  ...
  factory DrsUpdateRequestModel.fromJson(Map<String, dynamic> json) => DrsUpdateRequestModel(
    drsSummary: DrsUpdateSummary.fromJson(json["DRSSummary"]),
    updateDRSLits: List<DrsUpdateDetail>.from(json["UpdateDRSLits"].map((x) => DrsUpdateDetail.fromJson(x))),
...
class DrsUpdateSummary {
  ...
  factory DrsUpdateSummary.fromJson(Map<String, dynamic> json) => DrsUpdateSummary(
    pdcno: json["pdcno"] ?? "",
    pdCDt: json["pdC_Dt"] ?? "",
...
class DrsUpdateDetail {
  ...
  factory DrsUpdateDetail.fromJson(Map<String, dynamic> json) => DrsUpdateDetail(
    autoNo: (json["autoNo"] ?? 0).toInt(),
    dockno: json["dockno"] ?? "",
    docksf: json["docksf"] ?? ".",
